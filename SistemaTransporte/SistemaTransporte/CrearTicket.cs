...
namespace SistemaTransporte
{
    class CrearTicket
    {
        ...
        //string impresora = "\\\\LENOVO-PC\\Ticketera / Text Only"; // nombre exacto de la impresora como esta en el panel de control
        //string impresora = "\\\\LENOVO-PC\\Ticketera";
        string impresora = "\\\\PP360-Laptop\\Ticketera";
        int max, cort;
        ...
        {
            ticket = "SCC";   // agrega lineas de  encabezados
